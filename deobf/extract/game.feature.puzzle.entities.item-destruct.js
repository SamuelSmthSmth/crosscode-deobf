ig.module("game.feature.puzzle.entities.item-destruct").requires("impact.base.entity", "impact.feature.effect.effect-sheet", "game.feature.menu.menu-model").defines(function() {
    ...
    ig.ENTITY.ItemDestruct = ig.AnimatedEntity.extend({
        ...
        init: function(a, b, c, e) {
            ...
            a = sc.ITEM_DESTRUCT_TYPE[e.desType];
            this.permaDeath = e.perma || false;
            this.trigger = e.trigger || "";
            this.indestructible = e.indest || false;
            if (a) {
                if (e.enemyInfo && e.enemyInfo.type) {
                    this.enemyInfo = new sc.EnemyInfo(e.enemyInfo);
                    this.enemyChance = e.enemyInfo.chance || -1
                }
                this.typeData = a;
                Vec3.assign(this.coll.size, a.size);
                if (a.gravity != void 0) this.coll.zGravityFactor = a.gravity;
                this.boomEffect = new ig.EffectHandle(a.boom);
                this.debrisEffect = new ig.EffectHandle(a.debris);
                this.initAnimations(a.anims)
            } else {
                this.coll.size.x = 32;
                this.coll.size.y = 32
            }
            if (e._globalSettingKey) this.globalKey = {
                key: e._globalSettingKey,
                anim: e.desType
            };
            if (e = e.items) {
                e.sort(function(a, b) {
            ...
            e = ig.vars.get(this._getVarPrefix() + ".respawnTime");
            this.permaDeath ? ig.vars.get("map.itemDestructPerma" + this.mapId) && this.setDropped() : e && e > sc.combat.time && this.setDropped();
        ...
        onKill: function(a) {
            this.parent(a);
            this.boomEffect && this.boomEffect.clearCached();
            this.debrisEffect && this.debrisEffect.clearCached();
            this.enemyInfo && this.enemyInfo.clearCached()
        },
        update: function() {
            if (this.blinkTimer <=
                0) this.blinkTimer = Math.random() * 2 + 4;
            ...
            if (this.sprites.length > 1) {
                ...
                if (this.blinkTimer < 1) {
                    c = Math.round((this.blinkTimer - 0.15) / 0.85 * b);
                    c < 0 && (c = 0);
                    e = Math.round((1 - this.blinkTimer / 0.85) * b);
                    e < 0 && (e = 0)
                }
                a.setGfxCut(c, e)
            }
        ...
        ballHit: function(a) {
            ...
            var b = a.attackInfo && a.attackInfo.hasHint("CHARGED") ? sc.ATTACK_TYPE.MEDIUM :
                sc.ATTACK_TYPE.LIGHT,
                c = a.getHitCenter(this),
                b = sc.ATTACK_TYPE.HEAVY;
            sc.stats.addMap("player", "propsDestroyed", 1);
            sc.combat.showHitEffect(this, c, b, a.getElement(), false, false, true);
            this.destroy();
            return true
        },
        destroy: function() {
            ...
            this.typeData.effectOffset && Vec3.add(a, this.typeData.effectOffset);
            this.boomEffect.spawnFixed(a.x, a.y, this.coll.pos.z + this.coll.size.z / 2);
            this.debrisEffect.spawnFixed(a.x, a.y, this.coll.pos.z + this.coll.size.z / 2);
            this.dropItem();
            a = sc.combat.time +
                300;
            ig.vars.set(this._getVarPrefix() + ".respawnTime", a);
            this.permaDeath && ig.vars.set("map.itemDestructPerma" + this.mapId, true);
            this.trigger && !ig.vars.get(this.trigger) && ig.vars.set(this.trigger, true);
        ...
        dropItem: function() {
            for (var a = Math.random(), b = sc.model.player.params, c = b.getModifier("RANK_PLANTS") ? sc.model.getCombatRankDropRate() : 1, b = ((b.getModifier("DROP_CHANCE") || 0) + 1) * c * sc.newgame.getDropRateMultiplier(), c = 0; c < this.itemDrops.length; ++c) {
                var e = this.itemDrops[c];
                if (a <= e.prob * b || e.prob >= 1) {
                    this.globalKey && sc.menu.incrementDropCount(this.globalKey.key, this.globalKey.anim);
                    sc.ItemDropEntity.spawnDrops(this, ig.ENTITY_ALIGN.CENTER, ig.game.playerEntity,
                        e.id, 1, sc.ITEM_DROP_TYPE.PROP);
                    if (b > 1) b = Math.max(b - 1, 1);
                    else break
                }
            }
        },
