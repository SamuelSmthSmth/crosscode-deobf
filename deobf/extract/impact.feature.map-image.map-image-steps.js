ig.module("impact.feature.map-image.map-image-steps").requires("impact.base.action", "impact.base.event").defines(function() {
    ig.EVENT_STEP.SHOW_MAP_IMAGE = ig.EventStepBase.extend({
        ...
        init: function(b) {
            this.name = b.name;
            this.settings = ig.copy(b);
            delete this.settings.name;
            this.settings.tileSheet = new ig.TileSheet.createFromJson(b.tileSheet)
        },
        start: function() {
