ig.module("game.feature.font.font-system").requires("impact.base.font", "impact.base.game", "game.feature.combat.stat-change").defines(function() {
    sc.FONT_COLORS = {
        RED: 1,
        GREEN: 2,
        PURPLE: 3,
    ...
    for (e = 0; e < 6; e++) {
        ...
        sc.ITEMS_ICONS_MAPPING_RARITY["item-items-" + m] = [3, o++];
    ...
    sc.FontSystem = ig.GameAddon.extend({
        ...
        icons: {
            ...
            stats_large: new ig.Font("media/font/icons-buff-large.png",
                16, ig.MultiFont.ICON_START),
        ...
        colors: {
            ...
            orange_tiny: new ig.Image("media/font/colors/tiny-orange.png",
                7),
        ...
        font: new ig.MultiFont("media/font/hall-fetica-bold.png",
            16, 0),
        ...
        init: function() {
            ...
            this.smallFont.setMapping(a);
            this.tinyFont.setMapping(sc.STAT_CHANGE_ICONS);
            this.font.pushColorSet(sc.FONT_COLORS.RED,
                this.colors.red, "#ff6969");
            ...
            this.smallFont.pushColorSet(sc.FONT_COLORS.PURPLE,
                this.colors.purple_mid, "#ffe430");
        ...
        changeKeyCodeIcon: function(a, b) {
            ...
            this.gamepadIcons || this.font.setMapping(g);
