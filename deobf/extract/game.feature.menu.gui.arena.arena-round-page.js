ig.module("game.feature.menu.gui.arena.arena-round-page").requires("impact.feature.gui.base.box", "impact.feature.gui.gui", "impact.feature.gui.base.basic-gui", "game.feature.menu.gui.menu-misc", "game.feature.gui.base.misc").defines(function() {
    ...
    sc.ArenaChallengeEntry = ig.GuiElementBase.extend({
        ...
        init: function(b, a, d, c) {
            ...
            this.tiny = d || false;
            this.global = c || false;
            this.icon = sc.ARENA_CHALLENGES[b || "NO_MELEE"].icon || 1;
            if (this.tiny) {
                this.text = new sc.TextGui(ig.lang.get("sc.gui.arena.challenges.descriptions." + b), {
                    font: sc.fontsystem.tinyFont,
                    maxWidth: a - 13
                });
                this.text.setPos(13, 1);
                this.addChildGui(this.text);
                this.setSize(a, Math.max(this.text.hook.size.y + 4, 14))
            } else {
                this.text = new sc.TextGui(ig.lang.get("sc.gui.arena.challenges.descriptions." + b), {
                    font: sc.fontsystem.smallFont,
                    maxWidth: a - 21
                ...
                this.addChildGui(this.text);
                this.setSize(a, Math.max(this.text.hook.size.y + 4, 22))
            }
        },
        updateDrawables: function(b) {
            if (this.tiny) {
                b.addGfx(this.gfx, 0, 0, 364 + this.icon % 6 * 10, ~~(this.icon / 6) * 10, 10, 10);
                this.global && b.addGfx(this.gfx, 0, 0, 146, 48, 10, 10)
            } else {
