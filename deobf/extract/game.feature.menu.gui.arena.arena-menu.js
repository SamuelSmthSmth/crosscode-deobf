ig.module("game.feature.menu.gui.arena.arena-menu").requires("impact.feature.gui.gui", "impact.feature.gui.base.basic-gui", "game.feature.menu.gui.base-menu", "game.feature.menu.gui.menu-misc", "game.feature.menu.gui.arena.arena-list", "game.feature.menu.gui.menu-misc").defines(function() {
    sc.ArenaMenu = sc.ListInfoMenu.extend({
        ...
        onOverviewButtonPressed: function() {
            if (this.hotkeyOverview.active) {
                ...
                this.overview = new sc.ArenaCupOverview(this.roundList.currentCup,
                    function() {
                        this.overview = null
                    }.bind(this), true);
        ...
        modelChanged: function(b, a, d) {
            ...
            } else a == sc.MENU_EVENT.SYNOP_BUTTON_PRESS ? this.enterRoundMenu(d.key) : a == sc.MENU_EVENT.SYNOP_SET_INFO && (sc.menu.synopInfo ? this.info && this.info.setInfo(sc.menu.synopInfo.key, sc.menu.synopInfo.round) : this.info && this.info.setInfo())
        }
    })
});
ig.baked = !0;
