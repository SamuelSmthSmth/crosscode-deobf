ig.module("game.feature.arena.gui.arena-trophy-gui").requires("impact.feature.gui.gui", "impact.feature.gui.base.basic-gui", "impact.feature.gui.base.box", "game.feature.gui.base.text", "game.feature.menu.gui.menu-misc", "game.feature.menu.gui.arena.arena-misc", "game.feature.arena.gui.arena-effect-display", "game.feature.gui.widget.modal-dialog").defines(function() {
    sc.ArenaCupOverview = ig.GuiElementBase.extend({
        ...
        init: function(b, a) {
            ...
            var d = sc.arena.getCupCore(this.cup).noRush || false;
            this.content = new ig.GuiElementBase;
            this.content.setSize(280, 166 - (d ? 40 : 0));
            this.header =
                new sc.TextGui("");
            this.header.setAlign(ig.GUI_ALIGN_X.CENTER, ig.GUI_ALIGN_Y.TOP);
            this.header.setPos(0, -4);
            this.content.addChildGui(this.header);
            var c = new ig.ColorGui("#7E7E7E", 280, 1);
            c.setAlign(ig.GUI_ALIGN_X.CENTER, ig.GUI_ALIGN_Y.TOP);
            c.setPos(0, 13);
            ...
            c = new ig.ColorGui("#7E7E7E", 280, 1);
            c.setAlign(ig.GUI_ALIGN_X.CENTER, ig.GUI_ALIGN_Y.TOP);
            c.setPos(0, 13 + this.list.hook.size.y - 1);
            this.content.addChildGui(c);
            ...
            !d && this.content.addChildGui(this.rushTime);
            this.rushTime.hook.pos.x = this.rushTime.hook.pos.x + 24;
            c = new ig.ImageGui(this.gfx, 512, 207, 17, 16);
            c.setPos(-17, -1);
            this.rushTime.addChildGui(c);
            ...
            !d && this.content.addChildGui(this.rushChain);
                    ...
                    if (this.timer <= 0)
                        if (this.currentIndex == -1) {
                            ...
                            var b = this.entries[this.currentIndex],
                                a = new sc.ArenaCupOverview.MedalEntry(b.id, b.medal, false, b.isRush),
                                d = ~~(b.id / 10);
                            a.setPos(1 + b.id % 10 * 18, 2 + d * 18);
        ...
        addMedals: function() {
            ...
            var b = sc.arena.getCupProgress(this.cup),
                a = sc.arena.getCupCore(this.cup).noRush || false;
            if (b) {
                a || this.entries.push({
                    id: 0,
                ...
                for (var b = b.rounds, d = 0; d < b.length; d++) {
                    var c = b[d];
                    this.entries.push({
                        id: a ? d : d + 1,
                        medal: c.medal || 0,
            ...
            if (!this.done) {
                ...
                for (var b = this.currentIndex; b < this.entries.length; b++) {
                    var a = this.entries[this.currentIndex],
                        d = new sc.ArenaCupOverview.MedalEntry(a.id, a.medal, true, a.isRush),
                        c = ~~(a.id / 10);
