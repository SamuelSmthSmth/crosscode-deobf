        ...
        sc.BaseMenu.extend({
            ...
            showMenu: function(b, a) {
                ...
                if (sc.menu.menuHost == sc.MENU_SUBMENU.STATUS)
                    if (a == sc.MENU_SUBMENU.EQUIPMENT) sc.menu.buttonInteract.pushButtonGroup(this.temp_button_group);
                    else {
            ...
            hideMenu: function(b, a) {
                ...
                a != sc.MENU_SUBMENU.EQUIPMENT && sc.menu.moveLeaSprite(0, 0, sc.MENU_LEA_STATE.LARGE);
                this.pager.hide();
                this.elements.hide();
            ...
            exitMenu: function(b) {
                ...
                if (b != sc.MENU_SUBMENU.EQUIPMENT) {
                    sc.menu.menuHost = 0;
            ...
            createPages: function() {
                ...
                for (var b = this.pages.length; b--;) this.addChildGui(this.pages[b]);
                sc.menu.statusElement = sc.model.player.currentElementMode
            },
            setCurrentPage: function(b, a) {
                this.updateLea(b);
                this.pages[a].hide();
                this.pages[b].show();
                ig.interact.setBlockDelay(0.2)
            ...
            updateCurrentPage: function(b) {
                this.pages[sc.menu.statusPage].updatePage && this.pages[sc.menu.statusPage].updatePage(b)
            },
            updateLea: function(b, a) {
                switch (b) {
                    case sc.MENU_STATUS_PAGES.MAIN:
                        sc.menu.moveLeaSprite(0, -101, sc.MENU_LEA_STATE.SMALL, !a);
                        break;
                    default:
            ...
            onDiffButtonPressed: function() {
                if (this.hotkeyDiff.active) {
                    ...
                    var b = "\\i[help3]" + ig.lang.get("sc.gui.menu.hotkeys.diff-" + (sc.menu.statusDiff ? "hide" : "show"));
                    this.hotkeyDiff.setText(b)
                }
            },
            createHelpGui: function() {
                if (!this.helpGui) {
                    this.helpGui =
                        new sc.HelpScreen(this, ig.lang.get("sc.gui.menu.help-texts.status.title"), ig.lang.get("sc.gui.menu.help-texts.status.pages"), function() {
            ...
            updateHotkeys: function() {
                var b = "\\i[help3]" + ig.lang.get("sc.gui.menu.hotkeys.diff-" + (sc.menu.statusDiff ?
                    "hide" : "show"));
                this.hotkeyDiff.setText(b);
            ...
            onBackButtonPress: function() {
                ...
                sc.menu.popMenu();
                if (b == sc.MENU_SUBMENU.EQUIPMENT) sc.menu.previousMenu = sc.MENU_SUBMENU.START
            },
            modelChanged: function(b, a, d) {
                if (b == sc.menu)
                    if (a == sc.MENU_EVENT.STATUS_SET_PAGE) {
                        if (d != sc.menu.statusPage) {
                            this.setCurrentPage(sc.menu.statusPage, d);
                            this.updateHotkeys()
                        }
                    } else a == sc.MENU_EVENT.STATUS_SET_ELEMENT && this.updateCurrentPage()
            }
        })
});
ig.baked = !0;
