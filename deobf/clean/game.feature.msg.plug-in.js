 ...
 *
 * Module loader for the message/dialog feature. Aggregates the message
 * model, event trigger, all GUI components (message box, dream messages,
 * overlay, board, side-message HUD), and event steps. In the Weltmeister
 * editor, registers message editor panels and step coloring rules.
 */
