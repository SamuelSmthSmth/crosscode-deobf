 ...
 * Source module: `assets/js/game.compiled.js` → `ig.module("impact.feature.overlay.overlay-steps")`.
 *
 * Event/action steps to set the full-screen color overlay and the corner
 * overlays (with optional blink).
 */
ig.module("impact.feature.overlay.overlay-steps")
    ...
    ig.EVENT_STEP.SET_OVERLAY_CORNER = ig.EventStepBase.extend({
        ...
        init: function (settings) {
            ...
            this.blinkAlpha = settings.blinkAlpha;
        },
