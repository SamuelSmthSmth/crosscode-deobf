 ...
 *
 * Door type definitions for the major dungeon doors (cold dungeon, heat
 * dungeon entrance/master door, shockwave dungeon door, and the final
 * dungeon doors). Each defines the door's collision size, open wait/effect,
 * and the multi-part slide animations (idle/open/openFast/close) used when
 * the door opens and closes. All data, no logic.
 */
