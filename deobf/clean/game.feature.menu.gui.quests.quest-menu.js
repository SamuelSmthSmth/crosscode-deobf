 ...
 * Source module: `assets/js/game.compiled.js` → `ig.module("game.feature.menu.gui.quests.quest-menu")`.
 *
 * `sc.QuestMenu`: the quest log submenu container (`sc.BaseMenu`) — hosts
 * the quest info box / list / detail view, the sort menu and the help /
 * sort / task-favorite hotkeys.
 */
ig.module("game.feature.menu.gui.quests.quest-menu")
    .requires("impact.feature.gui.gui", "impact.feature.gui.base.basic-gui", "game.feature.menu.gui.quests.quest-misc", "game.feature.menu.gui.quests.quest-tab-list", "game.feature.menu.gui.quests.quest-details")
    .defines(function () {
    ...
    sc.QuestMenu = sc.BaseMenu.extend({
        ...
        init: function () {
            ...
            this.questListBox = new sc.QuestListBox;
            ...
            this.hotkeyTask = new sc.ButtonGui("\\i[help2]" + ig.lang.get("sc.gui.menu.quests.fav"), void 0, true, sc.BUTTON_TYPE.SMALL);
            ...
            this.sortMenu.addButton("questAccepted", sc.QUEST_SORT_TYPE.ACCEPTED, 0);
        ...
        createHelpGui: function () {
            if (!this.helpGui) {
                this.helpGui = new sc.HelpScreen(this, ig.lang.get("sc.gui.menu.help-texts.quests.title"), ig.lang.get("sc.gui.menu.help-texts.quests.pages"), function () {
        ...
        onAddHotkeys: function (commitToTopBar) {
            ...
            sc.menu.buttonInteract.addGlobalButton(this.hotkeyTask, this.onHotkeyTaskCheck.bind(this));
        ...
        _updateSortMenuButton: function (sortName) {
        ...
        modelChanged: function (model, event, data) {
            if (model == sc.menu)
                if (event == sc.MENU_EVENT.QUEST_SET_INFO) this.questInfoBox.setQuest(sc.menu.questInfo);
            ...
            } else if (event == sc.MENU_EVENT.QUEST_CHANGED_TAB) {
                this.sortMenu.active && this.sortMenu.hideSortMenu();
                data != sc.menu.questCurrentTab && this._updateSortMenuButton(this.questListBox.getCurrentSortText())
            } else event == sc.MENU_EVENT.SORT_LIST && this._updateSortMenuButton(data.text)
        }
    })
});
ig.baked = !0;
