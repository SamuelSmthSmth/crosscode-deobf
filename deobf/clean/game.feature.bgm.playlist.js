 ...
 * Source module: `assets/js/game.compiled.js` → `ig.module("game.feature.bgm.playlist")`.
 *
 * CrossCode's BGM playlist manager (`sc.BgmPlaylist`): per-map track
 * definitions with intro/loop/end segments, transition rules, volume
 * maps, switch-songs (element-mode tracks), and multi-audio support.
 */
