 ...
 * Source module: `assets/js/game.compiled.js` → `ig.module("game.config")`.
 *
 * Global CrossCode configuration: supported languages, system font metrics,
 * editor defaults, terrain type constants, and asset file paths. All data
 * below is kept value-identical to the original.
 */
ig.module("game.config").defines(function () {
    ...
    ig.DATABASE_FILE = "data/database.json";
