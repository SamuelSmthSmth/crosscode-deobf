 ...
 * Source module: `assets/js/game.compiled.js` → `ig.module("game.feature.credits.gui.credits-gui")`.
 *
 * The credits scroll GUI: renders vertically-scrolling credit sections
 * with configurable speeds, triggers (named jump points for the event
 * system), image inserts, and page breaks.
 */
