 ...
 * @description The Statistics menu container (sc.StatsMenu): a BaseMenu with
 *   the stats tab list, help hotkey, and circle-button tab switching.
 */
ig.module("game.feature.menu.gui.stats.stats-menu").requires("impact.feature.gui.gui", "impact.feature.gui.base.basic-gui", "game.feature.menu.gui.base-menu", "game.feature.menu.gui.menu-misc", "game.feature.menu.gui.stats.stats-list").defines(function() {
	sc.StatsMenu = sc.BaseMenu.extend({
		...
		removeObservers: function() {
			...
			sc.Model.removeObserver(sc.menu, this.list)
		},
		showMenu: function() {
			this.addObservers();
		...
		createHelpGui: function() {
			if (!this.helpGui) {
				this.helpGui = new sc.HelpScreen(this, ig.lang.get("sc.gui.menu.help-texts.stats.title"), ig.lang.get("sc.gui.menu.help-texts.stats.pages"), function() {
