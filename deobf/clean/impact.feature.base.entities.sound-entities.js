 ...
 * Source module: `assets/js/game.compiled.js` → `ig.module("impact.feature.base.entities.sound-entities")`.
 *
 * `ig.ENTITY.SoundSource`: a map entity that plays a looping sound attached
 * to its position, audible within `radius`.
 */
ig.module("impact.feature.base.entities.sound-entities")
    ...
    ig.ENTITY.SoundSource = ig.Entity.extend({
        ...
        init: function (x, y, z, settings) {
            ...
            if (settings.sound) this.sound = new ig.Sound(settings.sound, settings.volume || 1);
            this.coll.type = ig.COLLTYPE.NONE;
            this.coll.setSize(16, 16, 0);
            this.radius = settings.radius || 0;
            this.rangeType = settings.rangeType || ig.SOUND_RANGE_TYPE.CIRCULAR;
            this.settings = {
