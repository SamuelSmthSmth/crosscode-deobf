...
| `events/` | Shared event-sheet snippets | [07-event-sheet](formats/07-event-sheet.md) | — |
| `global-settings.json` | Per-entity default config (incl. ItemDestruct loot) | [13-misc](formats/13-misc.md) | — |
...
| `save-presets/` | New-game preset saves | [13-misc](formats/13-misc.md) | — |
...
| `terrain.json` | Tileset → per-tile terrain ids | [13-misc](formats/13-misc.md) | — |
| `tile-infos.json` | Per-tile metadata (solidity, auto-tiles) | [13-misc](formats/13-misc.md) | — |
