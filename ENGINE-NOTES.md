...
## 10. Community deliverables (added 2026-08-25)

- **`symbol-map.json`** — generated by `build-symbol-map.js` (root). Maps every
  minified identifier back to its clean name per module (489 modules, ~15.7k
